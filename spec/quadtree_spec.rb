describe "d3 - quadtree" do
  ...
  it "d3.quadtree" do
    expect(CY.quadtree).to be_instance_of(CY::QuadTree)
  end
  ...
  it "quadtree.root" do
    q = CY.quadtree([a, b, c])
    root = q.root
    expect(root).to be_instance_of(CY::Quad)
  ...
  it "quadtree.x/y constructor" do
    q = CY.quadtree([a, b, c], proc{|(x,y,n)| x*10}, proc{|(x,y,n)| y*10})
