describe "d3 - curve" do
  ...
  describe "curve_bundle" do
    ...
    it do
      expect(curve).to be_instance_of(CY::CurveBundle)
    ...
    describe ".beta" do
      let(:curve) { CY.curve_bundle.beta(0.5) }
      it do
        expect(curve).to be_instance_of(CY::CurveBundle)
  ...
  describe "curve_cardinal_closed" do
    ...
    describe ".tension" do
      let(:curve) { CY.curve_cardinal_closed.tension(0.5) }
      it do
        expect(curve).to be_instance_of(CY::CurveCardinal)
  ...
  describe "curve_cardinal_open" do
    ...
    describe ".tension" do
      let(:curve) { CY.curve_cardinal_open.tension(0.5) }
      it do
        expect(curve).to be_instance_of(CY::CurveCardinal)
  ...
  describe "curve_catmull_rom_closed" do
    ...
    describe ".alpha" do
      let(:curve) { CY.curve_catmull_rom_closed.alpha(0.75) }
      it do
        expect(curve).to be_instance_of(CY::CurveCatmullRom)
  ...
  describe "curve_catmull_rom_open" do
    ...
    describe ".alpha" do
      let(:curve) { CY.curve_catmull_rom_open.alpha(0.75) }
      it do
        expect(curve).to be_instance_of(CY::CurveCatmullRom)
