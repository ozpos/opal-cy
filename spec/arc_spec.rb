describe "d3 - arc" do
  it "d3.arc" do
    expect(CY.arc).to be_instance_of(CY::ArcGenerator)
  end
  ...
  it "arc.start_angle" do
    arc = CY.arc.start_angle(Math::PI/2)
  ...
  it "arc.end_angle" do
    arc = CY.arc.end_angle(3*Math::PI/2)
